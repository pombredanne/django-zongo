...
class FrontShow(models.Model):
    ...
    image_lg = models.ImageField(upload_to='frontimg', null=True, verbose_name=_(u'Image lg (1170px)'))
    image_md = models.ImageField(upload_to='frontimg', blank=True, null=True, verbose_name=_(u'Image md (970px)'))
    image_sm = models.ImageField(upload_to='frontimg', blank=True, null=True, verbose_name=_(u'Image sm (750px)'))
    image_xs = models.ImageField(upload_to='frontimg', blank=True, null=True, verbose_name=_(u'Image xs (<750px)'))
    image_custom = models.ImageField(upload_to='frontimg', blank=True, null=True, verbose_name=_(u'Image custom breakpoint'))
